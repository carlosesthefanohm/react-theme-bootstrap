import React, { useState, useEffect, Fragment, useMemo, useCallback, forwardRef } from 'react';
...
var renderIconHtml = function renderIconHtml(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: style
  }, type === 'icon' ? /*#__PURE__*/React.createElement("i", {
    className: content
...
var CustomDropdown = function CustomDropdown(_ref2) {
  ...
  return forwardRef(function (_ref3, ref) {
...
var Layout = function Layout(_ref4) {
  ...
  var _useState = useState(!openNavDesktop),
      resize = _useState[0],
  ...
  useEffect(function () {
    ...
    permissions.forEach(function (d) {
      if (showLevelOne) {
        nav.push( /*#__PURE__*/React.createElement("div", {
          className: "nav-title"
        }, /*#__PURE__*/React.createElement("span", null, d.parent.name_tag)));
      }
      ...
      d.childrens.forEach(function (p) {
        ...
        p.childrens.forEach(function (ch) {
          ...
          childs.push( /*#__PURE__*/React.createElement(Link, {
            to: linkTo({
              url: ch.href_tag
            }),
          ...
          }, ch.href_tag === page && borderLayoutLeft ? /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("div", {
          ...
          }, ch !== null && ch !== void 0 && ch.icon_tag ? /*#__PURE__*/React.createElement("span", {
        ...
        nav.push( /*#__PURE__*/React.createElement("ul", {
          className: "nav-one-level"
        }, /*#__PURE__*/React.createElement("li", {
          className: "nav-one-level-item"
        }, showLevelTwo ? /*#__PURE__*/React.createElement("div", {
        ...
        }, p.parent.name_tag)), /*#__PURE__*/React.createElement("span", {
  ...
  var breadCrumb = useMemo(function () {
    ...
    }, bread.parent), /*#__PURE__*/React.createElement("div", {
      className: "page-wrapper-braedcrumbd-icon"
    }), /*#__PURE__*/React.createElement("div", {
      className: "page-wrapper-braedcrumbd-title"
    }, bread.child), /*#__PURE__*/React.createElement("div", {
      className: "page-wrapper-braedcrumbd-icon"
    }), /*#__PURE__*/React.createElement("div", {
      className: "page-wrapper-braedcrumbd-title active"
    }, bread.current));
  }, [page, permissions]);
  var resizeNav = useCallback(function () {
    if (resize) {
      if (resizeOpen) {
        return '';
      } else {
  ...
  var openNavMobile = useCallback(function () {
  ...
  }))), borderLayoutTop ? /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  })) , React.Children.toArray(renderIcon(iconsLeft))), /*#__PURE__*/React.createElement("div", {
    className: "hd-content-icon hd-icon-center"
  }, React.Children.toArray(renderIcon(iconsCenter))), /*#__PURE__*/React.createElement("div", {
    className: "hd-content-icon hd-icon-right"
  }, React.Children.toArray(renderIcon(iconsRight))), /*#__PURE__*/React.createElement("div", {
  ...
  }, contentBeforeNavigation), React.Children.toArray(navigation)), /*#__PURE__*/React.createElement("div", {
  ...
  }, !hideTop ? /*#__PURE__*/React.createElement("div", {
    className: "page-wrapper-top d-flex justify-content-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", {
    className: "page-wrapper-title"
  }, titleTop ? titleTop : title), showBread ? /*#__PURE__*/React.createElement("div", {
    className: "page-wrapper-breadcrumb"
  }, breadCrumb) : ''), /*#__PURE__*/React.createElement("div", null, pageWrapperContentRight)) : '', /*#__PURE__*/React.createElement("div", {
...
var Auth = function Auth(_ref) {
  ...
  }, "Nombre de usuario"), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Recordarme"))), /*#__PURE__*/React.createElement("div", {
    className: "col-12 mt-2"
  }, /*#__PURE__*/React.createElement("button", {
    type: "submit",
    className: 'btn btn-block btn-' + btnColor
  }, loadSubmit ? /*#__PURE__*/React.createElement("i", {
    className: "fa fa-circle-notch fa-spin"
  }) : /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement("i", {
...
var AuthV2 = function AuthV2(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "ACCESAR")), /*#__PURE__*/React.createElement("div", {
    className: "col-12 mb-2"
  }, /*#__PURE__*/React.createElement("small", {
    ...
    className: "fa fa-circle-notch fa-spin"
  }) : /*#__PURE__*/React.createElement(Fragment, null, "\xA0\xA0\xA0INGRESAR\xA0\xA0\xA0")))))))));
};
...
var AuthV3 = function AuthV3(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "invalid-feedback"
  }, "Necesita introducir un email"))), /*#__PURE__*/React.createElement("div", {
    className: "col-12 mb-3"
  }, /*#__PURE__*/React.createElement("small", {
    className: "text-white font-weight-bold"
  }, "Contrase\xF1a"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "invalid-feedback"
  }, "Necesita introducir una contrase\xF1a"))), /*#__PURE__*/React.createElement("div", {
    className: "col-12 mt-3"
  }, /*#__PURE__*/React.createElement("button", {
    type: "submit",
    ...
    className: "fa fa-circle-notch fa-spin"
  }) : /*#__PURE__*/React.createElement(Fragment, null, "Ingresar Ahora"))))))));
};
...
var NotFound = function NotFound(_ref) {
  ...
  }, "No Existe La P\xE1gina"), /*#__PURE__*/React.createElement(Link, {
    to: backUrl,
...
export { Auth, AuthV2, AuthV3, Layout, NotFound, Preloading };
